/*
 ...
 Source Schema         : clothing_mall

 Target Server Type    : MySQL
 Target Server Version : 50728
 File Encoding         : 65001

 Date: 14/03/2021 16:36:15
*/
...
CREATE TABLE `mall_address`  (
  ...
  `province` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '行政区域表的省ID',
  `city` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '行政区域表的市ID',
  `area` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '行政区域表的区县ID',
  ...
  `add_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` tinyint(1) DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`address_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 83 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '收货地址表' ROW_FORMAT = Compact;
...
INSERT INTO `mall_address` VALUES (82, 'tesst', 201, '山西省', '阳泉市', '郊区', 'test', '13456857756', 0, '2021-03-08 14:47:09', '2021-03-08 14:47:09', 0);
...
CREATE TABLE `mall_admin`  (
  ...
  `add_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '添加时间',
  `update_time` datetime(0) DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
-- ----------------------------
INSERT INTO `mall_admin` VALUES (2, 'admin123', 'YWRtaW4xMjM=', 'http://localhost:8089/img/cat.jpg', '2021-03-14 16:34:57', '2021-02-19 16:36:14', '2021-03-14 16:34:57', 0);
...
CREATE TABLE `mall_cart`  (
  ...
  `goods_sn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货物id',
...
INSERT INTO `mall_cart` VALUES (29, 201, 'cs2021022805', 1, 1, '2021-03-08 14:46:26', '2021-03-08 14:47:19', 0);
INSERT INTO `mall_cart` VALUES (30, 201, 'cs2021022804', 0, 3, '2021-03-13 02:29:22', '2021-03-13 02:29:22', 0);
INSERT INTO `mall_cart` VALUES (31, 201, 'cs2021022803', 0, 1, '2021-03-13 02:32:27', '2021-03-13 02:32:27', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 100101312 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '类目表' ROW_FORMAT = Compact;
...
CREATE TABLE `mall_collection`  (
  ...
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `goods_id` int(11) DEFAULT NULL COMMENT '货物sn',
  `add_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` int(1) DEFAULT 0 COMMENT '逻辑删除',
...
CREATE TABLE `mall_comment`  (
  ...
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户表的用户ID',
  `goods_sn` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `order_sn` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `star` smallint(6) DEFAULT 1 COMMENT '评分， 1-5',
  `add_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` tinyint(1) DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`comment_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1031 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评论表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of mall_comment
-- ----------------------------
INSERT INTO `mall_comment` VALUES (1030, 'test', 201, 'cs2021022805', '20210308024719483', 5, '2021-03-13 18:45:17', '2021-03-14 13:59:55', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23916 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品基本信息表' ROW_FORMAT = Compact;
...
CREATE TABLE `mall_order`  (
  ...
  `order_status` smallint(6) NOT NULL DEFAULT 1 COMMENT '订单状态(0.未支付 1.已支付 2.已发货,3.已收货,4.已取消,)',
  `message` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户订单留言',
  `order_price` decimal(10, 2) NOT NULL COMMENT '订单费用',
  `ship_time` datetime(0) DEFAULT NULL COMMENT '发货开始时间',
  `ship_sn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '物流单号',
  `confirm_time` datetime(0) DEFAULT NULL COMMENT '用户确认收货时间',
  `end_time` datetime(0) DEFAULT NULL COMMENT '订单关闭时间',
  `add_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `deleted` tinyint(1) DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`order_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 176 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of mall_order
-- ----------------------------
INSERT INTO `mall_order` VALUES (173, 204, 81, '20210305040209262', 2, '', 607.00, NULL, 'wl1256984261', NULL, NULL, '2021-03-05 16:02:09', '2021-03-14 15:06:18', 0);
INSERT INTO `mall_order` VALUES (174, 204, 81, '20210305041601758', 1, '', 1045.00, NULL, 'wl7595631548', NULL, NULL, '2021-03-05 16:16:01', '2021-03-14 14:27:05', 0);
INSERT INTO `mall_order` VALUES (175, 201, 82, '20210308024719483', 1, '', 100.00, NULL, 'wl7512364562', NULL, NULL, '2021-03-08 14:47:19', '2021-03-14 14:27:36', 0);
...
CREATE TABLE `mall_order_goods`  (
  ...
  `order_sn` varchar(63) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '订单编号',
  `goods_sn` varchar(63) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '货物编号',
...
-- ----------------------------
INSERT INTO `mall_order_goods` VALUES (13, '20210305040209262', 'cs2021022803', 1, '2021-03-05 16:02:09', '2021-03-14 15:06:34', 0);
INSERT INTO `mall_order_goods` VALUES (14, '20210305040209262', 'nz2021022802', 1, '2021-03-05 16:02:09', '2021-03-14 15:06:31', 0);
...
INSERT INTO `mall_order_goods` VALUES (17, '20210308024719483', 'cs2021022805', 1, '2021-03-08 14:47:19', '2021-03-08 14:47:19', 0);
...
CREATE TABLE `mall_user`  (
  ...
  `gender` int(3) NOT NULL DEFAULT 1 COMMENT '性别： 1男， 2 女',
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'http://localhost:8089/img/cat.jpg' COMMENT '用户头像图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 205 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
...
INSERT INTO `mall_user` VALUES (201, 'test001', 'test001', 2, '2021-02-12', '2021-03-14 13:30:00', '127.0.0.1', 'test', '13735906695', 'http://localhost:8089/img/27b961ae3cf94e9598c278a8462dbe16.jpg', 0, '2021-02-27 23:41:24', '2021-03-14 13:30:00', 0);
INSERT INTO `mall_user` VALUES (203, 'qqq', 'MTIzNDU2', 1, '2020-10-17', NULL, '', 's', '794642131', 'http://localhost:8089/img/cat.jpg', 0, '2021-02-27 23:46:07', '2021-03-14 15:34:47', 1);
INSERT INTO `mall_user` VALUES (204, 'test002', 'test002', 1, NULL, '2021-03-13 18:12:20', '127.0.0.1', '', '', 'http://localhost:8089/img/cat.jpg', 0, '2021-03-03 09:50:21', '2021-03-13 18:12:20', 0);
