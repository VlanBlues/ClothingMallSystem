...
public class MyBatisPlusAutoCreateClassUtil {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/clothing_mall?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC");
